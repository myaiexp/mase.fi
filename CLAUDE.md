...
Store is `/var/www/html/updates.json`, served and fetched as `/updates.json`. Shape: `{"entries": [...], "projects": [...]}` — one fetch provides both arrays. Dates are ISO in JSON, Finnish DD.MM client-side.
