// Unit tests for dates.js: normalizeDate, parseEntryDate, utcDayStart.
import { describe, it, expect } from 'vitest';
import { normalizeDate, parseEntryDate, utcDayStart } from './dates.js';
...
describe('normalizeDate → parseEntryDate coupling', () => {
  ...
  it('never throws toISOString for arbitrary input (feed dayLabel contract)', () => {
    const hostile = [
      '',
      null,
      undefined,
